...
def_THelper(cal_iw)
{
  ...
  def_INSTR_TAB("010000? ????? ????? 101 ????? ????? ??", sraiw);
  def_INSTR_TAB("000000? ????? ????? 101 ????? ????? ??", srliw);
  return EXEC_ID_inv;
}
...
def_THelper(calw)
{
  def_INSTR_TAB("??????? ????? ????? 000 ????? ????? ??", addw_subw_mulw);
...
def_THelper(main)
{
  ...
  def_INSTR_IDTAB("??????? ????? ????? ??? ????? 00100 11", I, cal_i);
  def_INSTR_IDTAB("??????? ????? ????? ??? ????? 00110 11", I, cal_iw);
  def_INSTR_IDTAB("??????? ????? ????? ??? ????? 11011 11", J, jal);
  def_INSTR_IDTAB("??????? ????? ????? ??? ????? 11001 11", I, jalr);
  def_INSTR_IDTAB("??????? ????? ????? ??? ????? 11000 11", B, branch);
  def_INSTR_IDTAB("??????? ????? ????? ??? ????? 01110 11", R, calw);
